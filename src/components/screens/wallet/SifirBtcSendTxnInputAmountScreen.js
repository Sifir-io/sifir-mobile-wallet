...
export default class SifirBtcSendTxnInputAmountScreen extends Component {
    ...
    goToConfirm = () => {
        ...
        this.props.navigation.navigate('BtcSendTxnConfirm', {txnInfo:{...txnInfo,amount},walletInfo});
    };
    render() {
        const{amount} = this.state;
        const {txnInfo: {address}, walletInfo:{balance}} = this.props.route.params;
        return (
                ...
                <View style={styles.contentView}>
                    ...
                    {amount > 0  && (
                        <TouchableOpacity
                            ...
                            shadowColor="black"
                            shadowOffset="30">
                            <View style={styles.btnStyle} onTouchEnd={() => this.goToConfirm()}>
